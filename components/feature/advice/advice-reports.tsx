...
const reportDataSources: ReportDataSource[] = [
  ...
  },
  {
    ...
    group: "advice",
    insight: "為替・原材料・物流・競合の変化を見て、中期の原価と価格戦略を見直せる。また、天候やトレンド変化を短期の販売施策へ反映できる。",
    decision: "原価上昇リスクが高い商材は、先回りで価格・仕入条件を調整する。また、週次トレンドが強いカテゴリは追加販促と在庫確保を優先する。",
    action: "値上げ余地のある重点商材を先に選定し、価格改定シミュレーションを行う。また、今週の販促テーマを天候・需要の強いカテゴリへ寄せる。",
  },
  {
    id: "advice-actions",
    label: "最適アクション候補",
